...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { company: @experience.company, period_of_employment: @experience.period_of_employment, title: @experience.title }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { company: @experience.company, period_of_employment: @experience.period_of_employment, title: @experience.title }
    assert_redirected_to experience_path(assigns(:experience))
  end
