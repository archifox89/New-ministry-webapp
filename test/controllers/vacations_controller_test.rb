...
class VacationsControllerTest < ActionController::TestCase
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post :create, vacation: { end_date: @vacation.end_date, start_date: @vacation.start_date, type: @vacation.type }
    end
  ...
  test "should update vacation" do
    patch :update, id: @vacation, vacation: { end_date: @vacation.end_date, start_date: @vacation.start_date, type: @vacation.type }
    assert_redirected_to vacation_path(assigns(:vacation))
  end
