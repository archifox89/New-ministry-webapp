...
class CircularsControllerTest < ActionController::TestCase
  ...
  test "should create circular" do
    assert_difference('Circular.count') do
      post :create, circular: { date_issued: @circular.date_issued, number: @circular.number, subject: @circular.subject }
    end
  ...
  test "should update circular" do
    patch :update, id: @circular, circular: { date_issued: @circular.date_issued, number: @circular.number, subject: @circular.subject }
    assert_redirected_to circular_path(assigns(:circular))
  end
